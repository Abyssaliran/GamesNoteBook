# Задачи практикума по языку Java

## 1. Нарды

+ Правила: [link](../../src/backgammon/backgammon-rules.md)
+ Играть: [ollgames.ru](https://ollgames.ru/korotkie-nardy-s-kompyuterom/)
+ Участники: Нарек Мелоян, Владислав Королев
+ Ветки: **backgammon**, **bg**

## 2. Архивы партий в базах данных

+ Участники: Роман Ананьев, Роман Гачегов,
Владимир Евграфов
+ Ветки: **jdbc** 

## 3. Алгоритмы игры в шахматы Тамерлана

+ Участники: Булат Нутфулин, Ровшан Махсудов
+ Ветки: **chessT**

## 4. Редактор начальных позиций игр

+ Участники: Алибек Нисанбаев
+ Ветки: **edit**

## 5. Матчи и турниры для алгоритмов игры

+ Участники:  
    + Павел Шулус (турниры по круговой системе)
    + Евгений Барзыгин (турниры по швейцарской системе)
+ Ветки: **tourney**

## 6. Алгоритмы игры в реверси

+ Участники: Медведенко
+ [Учебник](http://othello.gomel.by/stepanov/)
+ Ветки: **reversi**
...
+ Участники: Андрей Жосан, Анна Айрапетян, Роман Хозин
+ Ветки: **shogi**
