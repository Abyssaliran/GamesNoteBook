# Задачи практикума по языку Java 2020
...
Реализовать правила: Артем Конышев, Чжан Лян
Реализовать редактор начальных позиций: Чжан Лян 
...
Кирилл Голяков,
Рокировка а шахматах Фишера и алгритм игры (Player)
