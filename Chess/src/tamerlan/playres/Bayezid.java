 ...
 */
public class Bayezid extends MovePiecePlayer{
	private Comparator<? super Move> movesSorter = new BayezidBrain();
 ...
 * @author <a href="mailto:vladimir.romanov@gmail.com">Romanov V.Y.</a>
 */
class BayezidBrain extends PlayerBrain implements Comparator<Move> {
	@Override
