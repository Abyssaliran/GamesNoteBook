 ...
 */
public class Nasir extends MovePiecePlayer{
	private Comparator<? super Move> movesSorter = new NasirBrain();
...
/**
 * Алгоритм определения лучших ходов у турецкого султана Насира.
 * 
 * @author <a href="mailto:vladimir.romanov@gmail.com">Romanov V.Y.</a>
 */
class NasirBrain extends PlayerBrain implements Comparator<Move> {
	@Override
