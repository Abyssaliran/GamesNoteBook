 ...
 * 
 */
public class Tuqtamısh extends MovePiecePlayer{
	private Comparator<? super Move> movesSorter = new TuqtamıshBrain();
...
/**
 * Алгоритм определения лучших ходов у хана Золотой Орды Тохтамыша.
 * 
 */
class TuqtamıshBrain extends PlayerBrain implements Comparator<Move> {
	@Override
